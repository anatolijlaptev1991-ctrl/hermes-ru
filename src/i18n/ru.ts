...
// Russian locale for Hermes Agent Desktop
//
// This translation merges two independent community contributions:
//   • DrMaks22 (PR #72250) — native-reviewed Russian catalog, used as primary reference
//   • anatolijlaptev1991-ctrl (PR #71573) — additional keys + ё-fidelity corrections
//
// Both authors are native Russian speakers. The merged catalog takes the best
// variant from each source, with DrMaks22's hand-edited translations as baseline.
